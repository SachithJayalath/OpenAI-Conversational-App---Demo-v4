...
But exceptionally if this asked name is not found in the FS_Category (0 records returned) then you should return the closest matches to that name.
...
def main():
    ...
    st.header("AI Finance Assistant :satellite::milky_way:")
